...
elseif($task == "loadusers"){
	...
	while($get = $query->fetch_array()){
		...
		$url = "https://www.zipcodeapi.com/rest/YWyFpmQ5vPlIYvb3ti5vrJUjmXrH9E3DjxSTLJnA5F0KdZi4AyEOSlrqLp6Fqm2e/distance.json/".$zip1."/".$zip2."/mile";
		...
		<b>".$fName." ".$lName."</b>
		<br>
		<span class='text-vsmall'>".$aboutMe."</span>
